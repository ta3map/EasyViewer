...
Для точного маркирования и анализа значимых событий в электрофизиологических данных, программа предлагает функционал ручного добавления событий. 
Для этого используйте кнопку **Add Event** или сочетание клавиш **Ctrl** с кликом мыши на нужном участке графика.
