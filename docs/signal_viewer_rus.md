...
![Основное окно Signal Viewer](images/placeholder_signal_viewer_main.png)
...
![Загрузка ZAV файла](images/placeholder_load_zav_file.png)
...
![Загрузка EV файла](images/placeholder_load_ev_file.png)
...
![Слайдер времени](images/placeholder_time_slider.png)
...
![Единицы измерения времени](images/placeholder_time_units.png)
...
![Режим просмотра](images/placeholder_time_center_mode.png)
...
![Временное окно](images/placeholder_time_window.png)
...
![Кнопки навигации](images/placeholder_navigation_buttons.png)
...
![Дополнительные параметры](images/placeholder_additional_params.png)
...
![Настройки фильтрации](images/placeholder_filtering.png)
