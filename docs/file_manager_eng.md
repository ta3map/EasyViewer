...
![File Manager main window](screenshots/file_manager_main.png)
...
![Database selection](screenshots/file_manager_database.png)
...
![Creating project](screenshots/file_manager_new_project.png)

### Projects List

The left panel contains a list of all projects in the database. Selecting a project loads its files and groups.

![Projects list](screenshots/file_manager_projects_list.png)
...
![Group metadata](screenshots/file_manager_group_metadata.png)
...
![Adding files](screenshots/file_manager_add_file.png)
...
![Files list](screenshots/file_manager_files_list.png)
...
![File metadata](screenshots/file_manager_file_metadata.png)
...
![Module selection](screenshots/file_manager_module_selection.png)
...
![Module parameters configuration](screenshots/file_manager_module_params.png)
...
![Running module](screenshots/file_manager_run_module.png)
...
![Viewing results](screenshots/file_manager_view_results.png)
...
![Excel import](screenshots/file_manager_import_excel.png)
...
![File search](screenshots/file_manager_search.png)
...
![File Manager settings](screenshots/file_manager_settings.png)
