...
![Signal Viewer main window](images/placeholder_signal_viewer_main.png)
...
![Loading ZAV file](images/placeholder_load_zav_file.png)
...
![Loading EV file](images/placeholder_load_ev_file.png)
...
![Time slider](images/placeholder_time_slider.png)
...
![Time units](images/placeholder_time_units.png)
...
![View mode](images/placeholder_time_center_mode.png)
...
![Time window](images/placeholder_time_window.png)
...
![Navigation buttons](images/placeholder_navigation_buttons.png)
...
![Additional parameters](images/placeholder_additional_params.png)
...
![Events table](images/placeholder_events_table.png)
...
![Manual event addition settings](images/placeholder_manual_event_settings.png)
...
![Automatic event detection](images/placeholder_auto_detection.png)

### Editing Events

Menu **Options/Edit events** opens the events editing window. Allows changing event timestamps and comments.

![Editing events](images/placeholder_edit_events.png)
...
![Stimuli table](images/placeholder_stimuli_table.png)
...
![Editing stimuli](images/placeholder_edit_stimuli.png)
...
![Filtering settings](images/placeholder_filtering.png)
...
![Average subtraction](images/placeholder_average_subtraction.png)
...
![CSD settings](images/placeholder_csd_settings.png)
...
![Artifact removal](images/placeholder_artifact_removal.png)
...
![Mean trace by events](images/placeholder_mean_events.png)
