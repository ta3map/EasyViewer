...
![Cluster test result](screenshots/module_cluster_test.png)
...
![Mean stimulus result](screenshots/module_mean_stimulus.png)
...
![Stimulus detection result](screenshots/module_detect_stimuli.png)
...
![Slope measurement result](screenshots/module_slope_measurement.png)
...
![Module parameters configuration](screenshots/module_edit_params.png)
...
![Module queue](screenshots/module_queue.png)
...
![Module results](screenshots/module_results.png)
