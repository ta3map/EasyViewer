...
% zavp.realStim должен быть массивом структур с полем 'r'
...
% sweepProcessData ожидает spks размером [n_channels, n_sweeps]
...
% sweepProcessData ожидает lfpVar размером [n_channels, n_sweeps]
...
disp(['experiment: ' num2str(exper), ', index t1: ' num2str(t1), ', sweeps: ' num2str(n_sweeps)])
end
