...
ZAV файлы - это MAT файлы с определенной структурой переменных, которые используются в приложении Eviewer и Easy Viewer для анализа электрофизиологических данных. Основываясь на анализе кода в `signalViewerGUI.m` и функций конвертации, вот обязательная структура:
