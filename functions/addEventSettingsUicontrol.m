function addEventSettingsUicontrol()
    ...
    if ~isempty(guiFig)
        ...
        modeList = uicontrol('Style', 'popupmenu', 'Position', [x2pos, line2, 100, 22], 'String', {'manual', 'locked'}, 'Value', find(strcmp({'manual', 'locked'}, add_event_settings.mode)));
