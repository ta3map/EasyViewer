function plotChannelGrid_tiledlayout(params, actions)
%PLOTCHANNELGRID_TILEDLAYOUT Archived grid renderer (tiledlayout + axes per cell).
% Replaced by single-axes plotChannelGrid.m for better performance.
