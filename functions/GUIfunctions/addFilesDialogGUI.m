function filePaths = addFilesDialogGUI()
    ...
    uicontrol('Parent', dialogFig, 'Style', 'text', ...
        'Position', [margin, yPos, dialogWidth - 2*margin, labelHeight], ...
        'String', 'Select mode:', ...
    ...
    filesRadio = uicontrol('Parent', dialogFig, 'Style', 'radiobutton', ...
        'Position', [margin + 20, yPos, dialogWidth - 2*margin - 20, radioHeight], ...
    ...
    extensionList = {'All files', '.mat', '.ev', '.zav', '.db', '.txt', '.csv', '.abf'};
