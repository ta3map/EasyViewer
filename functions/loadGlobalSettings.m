function loadGlobalSettings()
    ...
    if ~exist(SettingsFilepath, 'file')
        try
            ...
            visualSettings = struct('show_full_signal', true, 'show_amplitude_labels', false, 'show_scale_bars', true, 'auto_shift', true, ...
    ...
    if exist(SettingsFilepath, 'file')
        try
            ...
            defaultVisualSettings = struct('show_full_signal', true, 'show_amplitude_labels', false, 'show_scale_bars', true, 'auto_shift', true, ...
                'side_panel_visible', true, 'stim_show', true, ...
                'show_spikes', false, 'show_CSD', false);
